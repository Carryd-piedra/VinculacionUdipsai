...
import Usuarios.Repositorios.AreaRepository;
import Usuarios.Repositorios.RolRepository;
import Usuarios.Repositorios.UsuarioRepository;
import Usuarios.entity.AreaEntity;
...
public class UsuarioService {
    ...
    public com.udipsai.ms_usuarios.service.dto.UsuarioDTO mapearDTO(UsuarioEntity usr) {
        com.udipsai.ms_usuarios.service.dto.UsuarioDTO dto = new com.udipsai.ms_usuarios.service.dto.UsuarioDTO(
                usr.getIdUsuario(),
                usr.getCedula(),
                usr.getEstado(),
                usr.getNombres(),
                ...
                usr.getUsuarioRoles().stream()
                        ...
                        .map(usuarioRol -> {
                            ...
                            com.udipsai.ms_usuarios.service.dto.RolDTO rolDTO = new com.udipsai.ms_usuarios.service.dto.RolDTO(
                                    rol.getIdRol(),
                                    rol.getNombre(),
                                    rol.getEstado());
                            return rolDTO;
                ...
                usr.getUsuarioAreas().stream()
                        ...
                        .map(usuarioArea -> {
                            ...
                            com.udipsai.ms_usuarios.service.dto.AreaDTO areaDTO = new com.udipsai.ms_usuarios.service.dto.AreaDTO(
                                    area.getIdArea(),
                                    area.getNombre(),
                                    area.getEstado());
                            return areaDTO;
    ...
    public List<com.udipsai.ms_usuarios.service.dto.UsuarioDTO> mapearDTOs(List<UsuarioEntity> usuarios) {
        List<com.udipsai.ms_usuarios.service.dto.UsuarioDTO> dtos = usuarios
                .stream()
    ...
    public ResponseEntity<Page<com.udipsai.ms_usuarios.service.dto.UsuarioDTO>> obtenerUsuarios(Pageable pageable) {
        ...
        Page<com.udipsai.ms_usuarios.service.dto.UsuarioDTO> usuariosDTOs = usuariosActivosPage.map(usr -> mapearDTO(usr));
        logger.info("200 OK: Usuarios activos obtenidos correctamente");
        return new ResponseEntity<>(usuariosDTOs, HttpStatus.OK);
    }

    // Obtener un Usuario especifico.
    public ResponseEntity<com.udipsai.ms_usuarios.service.dto.UsuarioDTO> obtenerUsuario(String cedula) {
        ...
        com.udipsai.ms_usuarios.service.dto.UsuarioDTO usuarioDTO = mapearDTO(usuario);
        logger.info("200 OK: Usuario obtenido correctamente");
        return new ResponseEntity<>(usuarioDTO, HttpStatus.OK);
    }

    // Obtener todos los Usuarios (A, I, B, N).
    public ResponseEntity<Page<com.udipsai.ms_usuarios.service.dto.UsuarioDTO>> obtenerUsuariosTodos(Pageable pageable) {
        logger.info("obtenerUsuarios()");
        logger.info("Obteniendo todos los usuarios");
        Page<UsuarioEntity> usuariosPage = usuarioRepo.findAll(pageable);
        Page<com.udipsai.ms_usuarios.service.dto.UsuarioDTO> usuariosDTOs = usuariosPage.map(usr -> mapearDTO(usr));
        logger.info("200 OK: Usuarios obtenidos correctamente");
        return new ResponseEntity<>(usuariosDTOs, HttpStatus.OK);
    }

    // Obtener todos los Usuarios inactivos.
    public ResponseEntity<Page<com.udipsai.ms_usuarios.service.dto.UsuarioDTO>> obtenerUsuariosInactivos(Pageable pageable) {
        ...
        Page<com.udipsai.ms_usuarios.service.dto.UsuarioDTO> usuariosDTOs = usuariosInactivosPage.map(usr -> mapearDTO(usr));
        logger.info("200 OK: Usuarios inactivos obtenidos correctamente");
        return new ResponseEntity<>(usuariosDTOs, HttpStatus.OK);
    }

    // Obtener todos los Usuarios bloqueados.
    public ResponseEntity<Page<com.udipsai.ms_usuarios.service.dto.UsuarioDTO>> obtenerUsuariosBloqueados(Pageable pageable) {
        ...
        Page<com.udipsai.ms_usuarios.service.dto.UsuarioDTO> usuariosDTOs = usuariosBloqueadosPage.map(usr -> mapearDTO(usr));
        logger.info("200 OK: Usuarios bloqueados obtenidos correctamente");
        return new ResponseEntity<>(usuariosDTOs, HttpStatus.OK);
    }

    // Obtener todos los Usuarios eliminados.
    public ResponseEntity<Page<com.udipsai.ms_usuarios.service.dto.UsuarioDTO>> obtenerUsuariosEliminados(Pageable pageable) {
        ...
        Page<com.udipsai.ms_usuarios.service.dto.UsuarioDTO> usuariosDTOs = usuariosEliminadosPage.map(usr -> mapearDTO(usr));
        logger.info("200 OK: Usuarios eliminados obtenidos correctamente");
        return new ResponseEntity<>(usuariosDTOs, HttpStatus.OK);
    }

    // Registrar un Usuario nuevo.
    public UsuarioEntity registrarUsuario(com.udipsai.ms_usuarios.service.dto.RegistrarUsuarioDTO usuario) {
    ...
    public ResponseEntity<?> cambiarContrasenia(String cedula, com.udipsai.ms_usuarios.service.dto.CambiarContraseniaDTO peticion) {
